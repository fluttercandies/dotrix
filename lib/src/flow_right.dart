...
/// FlowRight - Rightward flowing dot matrix indicator
///
/// Three independent waterfall rows flowing from left to right.
...
/// )
/// ```
class FlowRight extends DotIndicator {
  ...
  /// Rightward flow: Two light beams enter from left, move right, exit from right
  List<DotState> _calculateRow(double p) {
    // Dot positions: left=0, middle=0.5, right=1.0
    // Light beam moves from left (-0.25) to right (1.25)
